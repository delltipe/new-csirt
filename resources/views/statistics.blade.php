...
<style>
    ...
    .statistics-eyebrow { color: #D6E4F8; font-family: var(--font-display); font-size: 12px; font-weight: 700; letter-spacing: 0.08em; margin-bottom: 10px; text-transform: uppercase; }
    ...
    .statistics-intro { border: 1px solid var(--navy); color: var(--ink); margin: 0 auto 28px; max-width: 920px; padding: 18px 20px; background: var(--navy-tint); }
    ...
    .statistics-pagination a { align-items: center; border: 1px solid var(--border); color: var(--navy); display: inline-flex; font-family: var(--font-display); font-size: 13.5px; font-weight: 700; justify-content: center; min-height: 44px; min-width: 44px; padding: 0 16px; transition: background var(--ease), color var(--ease), border-color var(--ease); }
