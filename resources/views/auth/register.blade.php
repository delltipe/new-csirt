...
<div class="login-container">
    <div class="login-card">
        <div class="login-header">
            ...
            <p class="login-sub">Bergabung sebagai pelapor insiden siber</p>
        </div>
        <div class="login-body">
            ...
            <form method="POST" action="{{ route('register.submit') }}">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-input @error('name') is-invalid @enderror" id="name" name="name" value="{{ old('name') }}" required autofocus>
                    @error('name')
                ...
                <div class="form-group">
                    ...
                    <input type="email" class="form-input @error('email') is-invalid @enderror" id="email" name="email" value="{{ old('email') }}" required>
                    @error('email')
                    <div class="field-error"><i class="bi bi-exclamation-circle"></i> {{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    <label for="password_confirmation" class="form-label">Ulangi Kata Sandi <span class="req">*</span></label>
